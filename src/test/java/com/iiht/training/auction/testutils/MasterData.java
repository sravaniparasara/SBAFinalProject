...
public class MasterData {
	...
	public static SellerDto getSellerDto() {
		...
		sellerDto.setSellerFirstName("David");
		sellerDto.setSellerLastName("L");
	...
	public static ProductDto getProductDto() {
		...
		productDto.setshortDescription("8GB RAM 128 ROM");
		productDto.setDetailedDescription("8GB RAM and 128 ROM with 6inch display");
	...
	public static List<ProductDto> getProductDtoList() {
		...
		productDto.setshortDescription("Slim fit 36''");
